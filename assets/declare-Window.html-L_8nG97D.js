import{_ as n,o as s,c as a,e}from"./app-jV2LlyJZ.js";const t={},p=e(`<h2 id="给-window-增加一个简单的类型声明" tabindex="-1"><a class="header-anchor" href="#给-window-增加一个简单的类型声明" aria-hidden="true">#</a> 给 Window 增加一个简单的类型声明</h2><p>创建一个 <code>xxx.d.ts</code> 文件，使用 <code>declare</code> 声明类型 &lt;注意：此文件中不可以具有 <code>import</code> 等导入方法&gt;</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token operator">&lt;</span>env<span class="token punctuation">.</span>d<span class="token punctuation">.</span>ts<span class="token operator">&gt;</span>
