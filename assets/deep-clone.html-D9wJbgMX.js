import{_ as n,o as s,c as a,e as t}from"./app-DHuB2UE8.js";const e={},o=t(`<p>日常进行深拷贝时我们会使用 <em><strong>JSON.parse(JSON.stringify(data))</strong></em> 进行 copy <br> 但是对象内有函数，或者是数据过于复杂非扁平化就会出现数据丢失的问题 <br> 使用下面这个可以应对绝大多数需要深拷贝的场景</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
